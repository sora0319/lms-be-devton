...
public class DataGenerate {
    ...
    void part1() {
        ...
        User user5 = User.builder()
                .username("dskim")
                .name("김동수")
                .password(passwordEncoder.encode("password567"))
        ...
        User user6 = User.builder()
                .username("syjung")
                .name("정수영")
                .password(passwordEncoder.encode("password890"))
...
// 강사 7번 ~ 15번
        ...
        User user8 = User.builder()
                .username("mshin")
                .name("신미영")
                .password(passwordEncoder.encode("password222"))
        ...
        User user9 = User.builder()
                .username("jsong")
                .name("송지훈")
                .password(passwordEncoder.encode("password333"))
        ...
        User user12 = User.builder()
                .username("hpark")
                .name("박현정")
                .password(passwordEncoder.encode("password666"))
        ...
        User user13 = User.builder()
                .username("ksim")
                .name("심규동")
                .password(passwordEncoder.encode("password777"))
        ...
        User user14 = User.builder()
                .username("ojung")
                .name("정옥희")
                .password(passwordEncoder.encode("password888"))
        ...
        User user15 = User.builder()
                .username("ysong")
                .name("송영호")
                .password(passwordEncoder.encode("password999"))
